...
use reinstinct_model::gemma4_assistant::{Gemma4AssistantConfig, Gemma4AssistantModel};
use crate::KernelCache;
use crate::gemma4::{GpuGemma4, Gemma4GpuState};
use crate::qwen35::GpuMatvecTensor;
