...
//! a 30 dB SNR drop per-value (see `reinstinct_quant::turbo3` for the full
...
use reinstinct_quant::turbo3::{BLOCKS_PER_GROUP, BYTES_PER_BLOCK, CacheKind, ROT_GROUP};
use reinstinct_hip::{DeviceBuf, Module};
#[cfg(test)] use reinstinct_hip;
...
mod tests {
    use super::*;
    use reinstinct_quant::turbo3::{decode_rows, CacheKind};
    ...
    fn promote_q8_to_turbo3_round_trip() {
        ...
        reinstinct_hip::Device(0).synchronize().unwrap();
